...
contract Vote{
   ...
   // mapping(address => bool) public voters;
	...
	function fetchCandidateCount() public view returns(uint){
		return contestantsCount;
	}
		function getCandidates (uint _value)public view returns(Contestant memory){
		return contestants[_value];
	}
}